...
My preferred way of rendering is to use `ffmpeg`, instead of the default GIF rendered, because it creates videos rather than GIFs. You will need to [install ffpmeg](https://ffmpeg.org) on your computer separately. Using ffmpeg also allows for finer control over the frame rate of the animation and creates smaller files. I'll show how to use it below.
